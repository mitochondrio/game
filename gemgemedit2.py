...
BOARDWIDTH = 9 # how many columns in the board
...
HIGHLIGHTCOLOR = GREEN # color of the selected gem's border
BGCOLOR = BLACK # background color on the screen
GRIDCOLOR = ORANGE # color of the game board
...
def runGame():
    ...
    while True: # main game loop
        ...
        for event in pygame.event.get(): # event handling loop
            if event.type == QUIT or (event.type == KEYUP and event.key == K_ESCAPE):
                ...
                if event.pos == (lastMouseDownX, lastMouseDownY):
                    ...
                    firstSelectedGem = checkForGemClick((lastMouseDownX, lastMouseDownY)) #gem clicked at start of drag
                    clickedSpace = checkForGemClick(event.pos)
        ...
        if clickedSpace and not firstSelectedGem: #The first click of the game
